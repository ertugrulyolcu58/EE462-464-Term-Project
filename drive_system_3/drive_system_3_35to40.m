...
ylabel('Speed(km/h)');
xlabel('Time(s)');
title('Speed vs Time Driver Model 3');
grid minor
...
xlabel('Time(s)');
title('Line to Line Voltages vs Time Driver Model 3');
hold on 
plot(out.Vbc);
hold on
plot(out.Vca);
...
xlabel('Time(s)');
title('Line Currents vs Time Driver Model 3');
hold on 
plot(out.Ib);
hold on
plot(out.Ic);
...
ylabel('Torque(Nm)');
xlabel('Time(s)');
title('Torque vs Time Driver Model 3');
grid minor
...
xlabel('Time(s)');
title('dq Currents vs Time Driver Model 3');
hold on 
plot(out.q_current);
legend('I_d','I_q');
grid minor